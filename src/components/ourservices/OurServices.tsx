...
const OurServices = () => {
  return (
    <div class="max-w-full shadow-xl md:py-14">
      ...
      <div class="grid md:grid-cols-3 gap-7 grid-cols-2 dark:text-white justify-center md:pl-24">
        <For each={blogPosts}>
          {(blog) => (
            <div class="flex flex-col justify-center max-w-sm rounded overflow-hidden shadow-lg min-h-[350px]">
              <a href="/services" class="flex flex-col h-full">
                ...
                <div class="px-6 py-4 mt-auto text-center">
                  <button class="text-sm font-bold text-white bg-gradient-to-l from-cyan-600 to-blue-600 hover:bg-cyan-700 duration-1000 md:text-lg md:px-2 md:py-1 rounded-lg hover:scale-110 px-1 py-1">
                    Learn More {"->"}
                  </button>
                </div>
              </a>
